...
namespace MTKDeviceManager
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // Event handler wired in Form1 constructor
            ...
            this.tbDAFile.ReadOnly = true; // Typically read-only, set by dialog
        ...
        private async void BtnReadInfo_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    logProgress.Report("No DA file selected. Proceeding without it for operations that might not require it.\n");
                }
                ...
                {
                    logProgress.Report("Operation failed or was cancelled.\n");
                }
            }
            catch (Exception ex)
            {
                logProgress.Report($"An unexpected error occurred: {ex.Message}\nStack Trace: {ex.StackTrace}\n");
            }
            finally
            {
